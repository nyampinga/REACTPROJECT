...
const Programs = ()=>{
    ...
    return(
        ...
        <Card style={{width:"100%"}}>
            ...
            <Card.Grid style={{width:"60%",boxShadow:"2px white",border:"solid 2px white"}}>
            <img src={image1} alt="image" width="100%"/>
            </Card.Grid>

            <Card.Grid className="style">
                <h1 style={{fontSize:"60px",color:"blue", fontWeight:"bold",border:"white"}}> Our Program </h1>
    ...
    />
        ...
        <Card style={{width:"100%"}}>
            ...
            <Card.Grid hoverable={false} style={{width:"65%"}}>
                <h1 style={{fontSize:"60px",color:"blue", fontWeight:"bold",border:"white"}}> Scheduler your Session </h1>
            ...
            <Card style={{width:"100%"}}>
                ...
                <Card.Grid hoverable={false}  style={{width:"40%"}}>
                    <h1 style={{fontSize:"60px",color:"blue", fontWeight:"bold",border:"white"}}> Meet our Mentor </h1>
                    <p style={{fontSize:"20px",padding:"10px",border:"white"}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut tempus, vel sollicitudin pulvinar. Porttitor lobortis arcu interdum neque enim.</p>
                </Card.Grid>
